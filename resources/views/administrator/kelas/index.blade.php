<x-app-layout>
    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 dark:text-white">
        <div class="flex flex-col md:flex-row text-center justify-between gap-4">
            <h1 class="text-xl md:text-2xl font-semibold">Data Kelas</h1>
    ...
    <div id="dataModal" class="fixed inset-0 flex items-center justify-center z-[1100] hidden bg-black bg-opacity-50">
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-auto p-6">
            ...
            <form id="dataForm" autocomplete="off">
                ...
                <div class="flex flex-col w-full mb-2">
                    <label for="jmlbangku" class="block text-gray-700">Jumlah Bangku</label>
                    <input type="text" id="jmlbangku" name="jmlbangku" class="border shadow-sm rounded-md py-2 px-3">
                </div>

                <div class="flex flex-col w-full mb-4">
                    <label for="idguru" class="block text-gray-700">Guru Wali Kelas</label>
        ...
        $(document).ready(function() {
            ...
            $('#save').click(function(e) {
                ...
                const method = $("#method").val() === 'PUT' ? 'PUT' :
                    'POST';
                const url = method === "POST" ? "{{ route('admin.kelas.store') }}" :
                    "{{ route('admin.kelas.update') }}";
